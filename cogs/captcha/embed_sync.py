...
from modules.captcha import CaptchaGuildConfig, CaptchaSettingsUpdatePayload
from modules.captcha.client import CaptchaApiClient, CaptchaApiError, CaptchaNotAvailableError
from modules.utils import mysql

from .config import build_public_verification_url
from .utils import coerce_positive_int

_logger = logging.getLogger(__name__)

class CaptchaEmbedSyncMixin:
    ...
    async def _sync_guild_embed(
        ...
        *,
        ...
        channel_id = coerce_positive_int(settings.get("captcha-embed-channel-id"))
    ...
    def _build_verification_embed(
        ...
        view.add_item(
            discord.ui.Button(
                label="Verify now",
                url=build_public_verification_url(self._public_verify_url, guild.id),
