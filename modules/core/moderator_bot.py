...
class ModeratorBot(commands.Bot):
    def __init__(
        ...
        *,
        ...
        self._i18n_bootstrap_task: asyncio.Task[None] | None = None
        self._mysql_initialisation_task: asyncio.Task[None] | None = None
        self._extension_loader_task: asyncio.Task[None] | None = None
        self._guild_cache_preload_task: asyncio.Task[None] | None = None
        self._topgg_poster_task: asyncio.Task[None] | None = None
        self._guild_sync_task: asyncio.Task[None] | None = None
