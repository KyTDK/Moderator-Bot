...
async def get_aimod_usage(guild_id: int):
    ...
    if not row:
        ...
        return {"tokens_used": 0, "cost_usd": 0.0, "limit_usd": ACCELERATED_BUDGET_LIMIT_USD, "cycle_end": target_end}
    ...
    if target_end > stored_end:
        ...
        return {"tokens_used": 0, "cost_usd": 0.0, "limit_usd": float(limit_usd or ACCELERATED_BUDGET_LIMIT_USD), "cycle_end": target_end}
